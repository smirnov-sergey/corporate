...
<head>
    ...
    <!-- CSSs -->
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset(env('THEME')) }}/css/buttons.css">
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset(env('THEME')) }}/css/cache-custom.css">
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset(env('THEME')) }}/css/custom.css">
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset(env('THEME')) }}/css/font-awesome.css">
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset(env('THEME')) }}/css/max-width-320.css">
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset(env('THEME')) }}/css/max-width-480.css">
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset(env('THEME')) }}/css/max-width-768.css">
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset(env('THEME')) }}/css/max-width-1024.css">
