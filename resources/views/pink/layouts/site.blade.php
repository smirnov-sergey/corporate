        ...
        <div id="header" class="group">
            ...
            <div class="group inner">
                ...
                <div id="logo" class="group">
                    <a href="index.html" title="Pink Rio"><img src="images/logo.png" title="Pink Rio"
                                                               alt="Pink Rio"/></a>
                </div>
                <!-- END LOGO -->
            ...
            <ul class="slider">
                <li>
                    <div class="slide-holder"
                         style="background:  url('images/slider-cycle/xx.jpg') no-repeat center center"
                         style="height:483px;">
                        <div class="slide-content-holder inner" style="height:483px;">
                            <div class="slide-content-holder-content" style="position: absolute; top:30px;right:650px;">
                                ...
                                <div class="slide-content" style="color:#fff">
                                    <p>Nam id quam a odio euismod pellentesque. Etiam congue rutrum risus non
                                        vestibulum. Quisque a diam at ligula blandit consequat. Mauris ac mi velit, a
                                        tempor neque</p>
                                </div>
                            </div>
                        </div>
                ...
                <li>
                    <div class="slide-holder"
                         style="background:  url('images/slider-cycle/00314.jpg') no-repeat center center"
                         style="height:483px;">
                        <div class="slide-content-holder inner" style="height:483px;">
                ...
                <li>
                    <div class="slide-holder"
                         style="background:  url('images/slider-cycle/dd.jpg') no-repeat center center"
                         style="height:483px;">
                        <div class="slide-content-holder inner" style="height:483px;">
                        </div>
                    </div>
            ...
            <div id="yit-widget-area" class="group">
                <div class="yit-widget-content inner group">
                    ...
                    <div class="widget-last yit-widget widget col1_4 one-fourth col yit_text_quote">
                        <blockquote class="text-quote-quote">вЂњAnyone who has never made a mistake has never tried
                            anything new.вЂќ
                        </blockquote>
                        ...
                        <div class="section portfolio">
                            ...
                            <div class="hentry work group portfolio-sticky portfolio-full-description">
                                <div class="work-thumbnail">
                                    <a class="thumb"><img src="images/projects/0081-385x192.jpg" alt="0081"
                                                          title="0081"/></a>
                                    <div class="work-overlay">
                                        <h3><a href="project.html">Steep This!</a></h3>
                                        <p class="work-overlay-categories"><img src="images/categories.png"
                                                                                alt="Categories"/> in: <a
                                                    href="category.html">Brand Identity</a>, <a href="category.html">Web
                                                Design</a></p>
                                    </div>
                                </div>
                                <div class="work-description">
                                    <h2><a href="project.html">Steep This!</a></h2>
                                    <p class="work-categories">in: <a href="category.html">Brand Identity</a>, <a
                                                href="category.html">Web Design</a></p>
                                ...
                                <div class="related_project">
                                    <div class="overlay_a related_img">
                                        <div class="overlay_wrapper">
                                            ...
                                            <div class="overlay">
                                                <a class="overlay_img" href="images/projects/0061.jpg" rel="lightbox"
                                                   title=""></a>
                                ...
                                <div class="related_project">
                                    <div class="overlay_a related_img">
                                        <div class="overlay_wrapper">
                                            ...
                                            <div class="overlay">
                                                <a class="overlay_img" href="images/projects/0071.jpg" rel="lightbox"
                                                   title=""></a>
                                                <a class="overlay_project" href="project.html"></a>
                                ...
                                <div class="related_project">
                                    <div class="overlay_a related_img">
                                        <div class="overlay_wrapper">
                                            ...
                                            <div class="overlay">
                                                <a class="overlay_img" href="images/projects/009.jpg" rel="lightbox"
                                                   title=""></a>
                                                <a class="overlay_project" href="project.html"></a>
                                ...
                                <div class="related_project_last related_project">
                                    <div class="overlay_a related_img">
                                        <div class="overlay_wrapper">
                                            ...
                                            <div class="overlay">
                                                <a class="overlay_img" href="images/projects/0011.jpg" rel="lightbox"
                                                   title=""></a>
                                                <a class="overlay_project" href="project.html"></a>
