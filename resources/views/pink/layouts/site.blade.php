...
<head>
    ...
    <script type="text/javascript" src="{{ asset(config('settings.theme')) }}/js/save_comment.js"></script>
...
<div class="bg-shadow">
        ...
        <!-- START PAGE META -->
            <div id="page-meta">
                <div class="inner group">
                    <h3>Добро пожаловать на страницу портфолио</h3>
                        <h4>... надеюсь вам понравятся работы</h4>
                </div>
            </div>
            <!-- END PAGE META -->
    @endif
    ...
    @if(Route::currentRouteName()  == 'contacts')
        <!-- START PAGE META -->
            <div id="page-meta">
                <div class="inner group">
                    <h3>Добро пожаловать на страницу контактов</h3>
                    <h4>... будем рады знакомству</h4>
                </div>
            </div>
            <!-- END PAGE META -->
    @endif
